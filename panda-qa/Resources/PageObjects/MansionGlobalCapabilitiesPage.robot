...
Validate Follow Hotlink for Authors
    ...
    Validate author show all records
...
Capabilities Dashboard Mansion Global Menu
    Click Button  //*[text()="Mansion Global"]/../../a
    Wait Until Element Is Visible  //h1[text()="Mansion Global"]
