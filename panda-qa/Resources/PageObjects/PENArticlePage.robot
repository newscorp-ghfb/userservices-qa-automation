...
*** Variables ***
${JSFollowButtonPENPath}=  document.querySelector('ufc-follow-author-widget').shadowRoot  #1
...
Validate author without byline
    Page Should Contain Element  //span[contains(text(),'James Booth')]  #//span[text()="James Booth"]
